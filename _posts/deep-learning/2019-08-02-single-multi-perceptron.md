...
![action-potential]({{ site.url }}{{ site.baseurl }}/images/perceptron/action_potential_khan.png)

## 2. **Single Layer Perceptron**
![SLP]({{ site.url }}{{ site.baseurl }}/images/perceptron/SLP.png)
...
![MLP]({{ site.url }}{{ site.baseurl }}/images/perceptron/MLP.jpg)  
...
plt.show()
```
![Visualisation]({{ site.url }}{{ site.baseurl }}/images/perceptron/activation_functions.png)
